    ...
    <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
        <form class="add-new-user pt-0" id="addNewUserForm" method="POST" action="{{ route('users.store') }}">
            ...
            <div class="mb-6 form-control-validation">
                ...
                <input type="text" class="form-control" id="add-user-fullname" name="name" placeholder="John Doe" required />
            </div>
            <div class="mb-6 form-control-validation">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="add-user-contact" class="form-control" name="mobile" placeholder="9999999999" required  />
            </div>
           <div class="mb-6">
                <label class="form-label" for="user-role">User Roles</label>
                <select id="user-role" name="roles[]" class="form-select" multiple required>
